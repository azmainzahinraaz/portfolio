      ...
      {Object.entries(contactLinks).map(([platform, url]) => {
        return (
          <Link
            ...
            className="text-white w-10.25 h-10.25 flex items-center justify-center rounded-full bg-blue hover:bg-light-gray/40 hover:text-white focus:bg-light-gray/40 focus:text-black transition-colors duration-200"
          >
